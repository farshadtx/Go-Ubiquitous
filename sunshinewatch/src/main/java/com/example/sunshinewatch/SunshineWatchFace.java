...
public class SunshineWatchFace extends CanvasWatchFaceService {
    ...
    private class Engine extends CanvasWatchFaceService.Engine implements DataApi.DataListener,
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            mTextDatePaint = createTextPaint(resources.getColor(R.color.primary_text_light), NORMAL_TYPEFACE);
            ...
            mTextTempLowPaint = createTextPaint(resources.getColor(R.color.primary_text_light), NORMAL_TYPEFACE);
        ...
        public void onDraw(Canvas canvas, Rect bounds) {
            ...
            String amPmText = com.example.android.sunshine.app.Utility.getAmPmString(getResources(), am_pm);
            ...
            // Draw the date
            String dayOfWeekString   = com.example.android.sunshine.app.Utility.getDayOfWeekString(resources, mCalendar.get(Calendar.DAY_OF_WEEK));
            String monthOfYearString = com.example.android.sunshine.app.Utility.getMonthOfYearString(resources, mCalendar.get(Calendar.MONTH));
                ...
                if (dataEvent.getType() == DataEvent.TYPE_CHANGED) {
                    ...
                    if (path.equals(WEATHER_INFO_PATH)) {
                        ...
                        if (dataMap.containsKey(KEY_WEATHER_ID)) {
                            ...
                            Drawable b = getResources().getDrawable(com.example.android.sunshine.app.Utility.getIconResourceForWeatherCondition(weatherId));
